...
useEffect(() => {
 ...
 const navigate = useNavigate();
  ...
  async function mostrardados(){
    try {
        const response = await fetch(`http://10.1.2.106:5000/lista/${id}`, {
          method: "GET",
          headers: {
        ...
        if (response.ok) {
          ...
          setCombustivel(resposta.combustivel);
          setAr(resposta.ar);
          setAlarme(resposta.alarme);
          setDhCambio(resposta.dhCambio);
          setAutomatico(resposta.automatico);
          setAutomatizado(resposta.automatizado);
          setCvt(resposta.cvt);
          setManual(resposta.manual);
          setAbs(resposta.abs);
          setAirbag(resposta.airbag);
          setQxq(resposta.qxq);
          setQx2(resposta.qx2);
          setGasolina(resposta.gasolina);
          setEtanol(resposta.etanol);
          setFlex(resposta.flex);
          setGnv(resposta.gnv);
          setDiesel(resposta.diesel);
          setEstepe(resposta.estepe);
          setMacaco(resposta.macaco);
          setChaveDeRoda(resposta.chaveDeRoda);
          setTriangulo(resposta.triangulo);
          setAntena(resposta.antena);
          setVidroEletrico(resposta.vidroEletrico);
          setTravaEletrica(resposta.travaEletrica);
          setCalotas(resposta.calotas);
          setParaBrisaTrincado(resposta.paraBrisaTrincado);
          setRadio(resposta.radio);
          setCortaCorrente(resposta.cortaCorrente);
          setExtintor(resposta.extintor);
          setBuzina(resposta.buzina);
          setProtetorCarter(resposta.protetorCarter);
          setChaveSegredo(resposta.chaveSegredo);
          setTapetes(resposta.tapetes);
          setAcendedor(resposta.acendedor);
          setEntrada(resposta.entrada);
          setPrevisao(resposta.previsao);
          setPlaca(resposta.placa);
          setKmEntrada(resposta.kmEntrada);
          setKmSaida(resposta.kmSaida);
          setOs(resposta.os);
          setIdVeiculo(resposta.idVeiculo);
          setMarca(resposta.marca);
          setAno(resposta.ano);
          setCorPredominante(resposta.corPredominante);
          setChassis(resposta.chassis);
          setCodMotor(resposta.codMotor);
          setValvulas(resposta.valvulas);
          setCilindros(resposta.cilindros);
          setCilindradas(resposta.cilindradas);
          setSeguro(resposta.seguro);
          setLuzAnomalia(resposta.luzAnomalia);
